    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.PositiveSmallIntegerField(choices=[(1, 'New follow'), (2, 'New article'), (3, 'New album'), (4, 'New photo'), (5, 'Like of album'), (6, 'Like of photo'), (7, 'New comment'), (8, 'New review')], verbose_name='Reason')),
