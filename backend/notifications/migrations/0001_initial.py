    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.PositiveSmallIntegerField(choices=[(1, 'New follow'), (2, 'New album'), (3, 'New photo'), (4, 'Like of album'), (5, 'Like of photo'), (6, 'Comment of article'), (7, 'Comment of album'), (8, 'Comment of photo'), (9, 'New comment'), (10, 'New review')], verbose_name='Action')),
