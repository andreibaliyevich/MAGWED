...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('slug', models.CharField(choices=[(None, '(Unknown)'), ('design', 'Design'), ('fashion', 'Fashion'), ('inspiration', 'Inspiration'), ('journey', 'Journey'), ('lifestyle', 'Lifestyle'), ('photography', 'Photography'), ('technology', 'Technology'), ('wedding', 'Wedding')], max_length=16, primary_key=True, serialize=False, verbose_name='Slug')),
            ],
            options={
