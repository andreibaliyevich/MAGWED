    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='albums', to='accounts.organizer', verbose_name='Owner')),
            ],
            options={
                'verbose_name': 'Album',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='accounts.organizer', verbose_name='Owner')),
            ],
            options={
                'verbose_name': 'Photo',
