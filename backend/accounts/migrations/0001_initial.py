# Generated by Django 3.2.9 on 2022-05-12 06:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.IntegerField(choices=[(1, 'Administrator'), (2, 'Customer'), (3, 'Organizer')], verbose_name='User type')),
                ('name', models.CharField(blank=True, max_length=255, verbose_name='Name')),
                ('avatar', easy_thumbnails.fields.ThumbnailerImageField(blank=True, help_text='Upload JPG or PNG image. Required minimum of size 800 x 800.', null=True, upload_to=accounts.utilities.get_avatar_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=('jpg', 'png')), accounts.validators.MinimumImageSizeValidator(800, 800)], verbose_name='Avatar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='accounts.mwuser', verbose_name='User')),
                ('cover', models.ImageField(blank=True, help_text='Upload JPG or PNG image. Required minimum of size 1900 x 1200.', null=True, upload_to=main.utilities.get_cover_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=('jpg', 'png')), accounts.validators.MinimumImageSizeValidator(1900, 1200)], verbose_name='Cover')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('cost_work', models.DecimalField(decimal_places=2, default=0.0, help_text='Please enter in USD ($)', max_digits=8, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))], verbose_name='Cost of work')),
