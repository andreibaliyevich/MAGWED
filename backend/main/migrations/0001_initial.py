# Generated by Django 3.2.18 on 2023-05-16 04:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Country',
            fields=[
                ('code', models.CharField(choices=[(None, '(Unknown)'), ('BY', 'Belarus'), ('RU', 'Russia'), ('UA', 'Ukraine')], max_length=2, primary_key=True, serialize=False, verbose_name='Code')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Language',
            fields=[
                ('code', models.CharField(choices=[(None, '(Unknown)'), ('be', 'Belarusian'), ('en', 'English'), ('fr', 'French'), ('de', 'German'), ('pl', 'Polish'), ('pt', 'Portuguese'), ('ru', 'Russian'), ('uk', 'Ukrainian')], max_length=2, primary_key=True, serialize=False, verbose_name='Code')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='City',
            fields=[
                ('code', models.CharField(choices=[(None, '(Unknown)'), ('BY-BR', 'Brest'), ('BY-MI', 'Minsk'), ('RU-MO', 'Moscow'), ('RU-SP', 'Saint Petersburg'), ('UA-KY', 'Kyiv'), ('UA-OD', 'Odesa')], max_length=5, primary_key=True, serialize=False, verbose_name='Code')),
