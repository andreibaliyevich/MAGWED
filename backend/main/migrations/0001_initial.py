...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='City',
            fields=[
                ('code', models.CharField(choices=[('BY-BR', 'Brest'), ('BY-MI', 'Minsk'), ('RU-MO', 'Moscow'), ('RU-SP', 'Saint Petersburg'), ('UA-KY', 'Kyiv'), ('UA-OD', 'Odesa')], max_length=5, primary_key=True, serialize=False, verbose_name='Code')),
