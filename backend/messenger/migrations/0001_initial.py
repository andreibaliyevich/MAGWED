...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('msg_type', models.PositiveSmallIntegerField(choices=[(1, 'Text'), (2, 'Image'), (3, 'File')], verbose_name='Message type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', easy_thumbnails.fields.ThumbnailerImageField(blank=True, help_text='Upload JPG or PNG image. Required minimum of size 360 x 360.', null=True, upload_to=messenger.utilities.get_conversation_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=('jpg', 'png')), main.validators.MinimumImageSizeValidator(360, 360)], verbose_name='Image')),
