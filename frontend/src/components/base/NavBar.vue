      ...
      <div v-if="userStore.isLoggedIn" class="d-flex align-items-center">
        ...
        <div class="dropdown ms-3">
          <a ref="dropdownUser" id="dropdownUser" href="#" class="d-flex align-items-center text-decoration-none text-decoration-none text-dark" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
            ...
            <img v-else src="/user-avatar.jpg" class="rounded-circle" width="32" height="32" alt="avatar">
          </a>
          <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="dropdownUser">
            <li class="px-3 pt-2 pb-3">
              <div class="d-flex gap-2 align-items-center mb-1">
                ...
                <img v-else src="/user-avatar.jpg" class="rounded-circle" width="48" height="48" alt="avatar">
                <div class="ms-1">
