...
import YearsFilter from '@/components/blog/YearsFilter.vue'

const blogFiltersDrawer = ref(false)
</script>
    ...
    <v-row>
      ...
      >
        <div class="d-none d-md-block position-sticky mt-5">
          <div class="elevation-1 rounded-lg pa-3">
            <h6 class="text-h6">
              {{ $t('blog.categories') }}
            </h6>
            <CategoriesFilter />
          </div>
          <div class="elevation-1 rounded-lg mt-3 pa-3">
            <h6 class="text-h6">
              {{ $t('blog.years') }}
            </h6>
            <YearsFilter />
