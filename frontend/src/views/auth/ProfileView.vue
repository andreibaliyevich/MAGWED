    ...
    <div class="row">
      ...
      <div class="col-lg-8 px-5">
        ...
        <form @submit.prevent="updateProfile">
          <div class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.name') }}</label>
            <div class="col-sm-9">
          ...
          <div class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.country') }}</label>
            <div class="col-sm-9">
          ...
          <div class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.city') }}</label>
            <div class="col-sm-9">
          ...
          <div class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.phone') }}</label>
            <div class="col-sm-9">
              <input  v-model="phone" type="text" name="phone" maxlength="21" id="id_phone" class="form-control">
            </div>
          </div>

          <div v-if="userStore.user_type == 2" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.date_of_wedding') }}</label>
            <div class="col-sm-9">
              <input v-model="date_of_wedding" type="text" name="date_of_wedding" size="10" id="id_date_of_wedding" class="form-control">
            </div>
          </div>

          <div v-if="userStore.user_type == 3" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.roles') }}</label>
            <div class="col-sm-9">
          ...
          <div v-if="userStore.user_type == 3" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.description') }}</label>
            <div class="col-sm-9">
          ...
          <div v-if="userStore.user_type == 3" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.countries') }}</label>
            <div class="col-sm-9">
          ...
          <div v-if="userStore.user_type == 3" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.cities') }}</label>
            <div class="col-sm-9">
          ...
          <div v-if="userStore.user_type == 3" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.languages') }}</label>
            <div class="col-sm-9">
          ...
          <div v-if="userStore.user_type == 3" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.cost_work') }}</label>
            <div class="col-sm-9">
          ...
          <div v-if="userStore.user_type == 3" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.number_hours') }}</label>
            <div class="col-sm-9">
          ...
          <div v-if="userStore.user_type == 3" class="mb-3 row">
            <label for="id_name" class="col-sm-3 col-form-label">{{ $t('auth.profile.profile_url') }}</label>
            <div class="col-sm-9">
              <input v-model="profile_url" type="text" name="profile_url" maxlength="64" required="" id="id_profile_url" class="form-control">
            </div>
          </div>
